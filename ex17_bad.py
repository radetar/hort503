...
</script>	<noscript><meta http-equiv="refresh" content="0; URL=/files/U8FD10HA5/F8V5UTH0D/ex17_bad.py?nojsmode=1" /></noscript>
...
(function() {
	...
	<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/webpack.manifest.4f75d8f2c3ac8cc8ab85.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
	...
	<script type="text/javascript">
		...
		sb('set', 'token', '3307f436963e02d4f9eb85ce5159744c');
					...
					sb('set', 'user_id', "U8Q8YEZCJ");
							sb('set', 'user_' + "batch", "signup_api");
							sb('set', 'user_' + "created", "2018-01-09");
						sb('set', 'name_tag', "hort503-01-spring2018" + '/' + "rachael.detar");
				sb('track', 'pageview');
...
<script>TSSSB.env = (function() {
	...
	<script type="text/javascript">
		...
		window.addEventListener('load', function() {
	        ...
	        <title>ex17_bad.py | Hort 503-01 Spring 2018 Slack</title>
    ...
    <link href="https://a.slack-edge.com/fbd26/style/rollup-slack_kit_legacy_adapters.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">

			<!-- output_css "core" -->
    <link href="https://a.slack-edge.com/44379/style/rollup-plastic.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
    ...
    <link href="https://a.slack-edge.com/953b85/style/codemirror_overrides.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">

	<!-- output_css "file_pages" -->
    <link href="https://a.slack-edge.com/49105/style/rollup-file_pages.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
	...
	<!-- output_css "regular" -->
    <link href="https://a.slack-edge.com/7acfa/style/print.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
	...
	<div id="site_nav_contents">
		...
		<div id="user_menu">
			<div id="user_menu_contents">
				<div id="user_menu_avatar">
										<span class="member_image thumb_48" style="background-image: url('https://secure.gravatar.com/avatar/02ca67ae78f1829ea6fdb044a0547898.jpg?s=192&d=https%3A%2F%2Fa.slack-edge.com%2F7fa9%2Fimg%2Favatars%2Fava_0017-192.png')" data-thumb-size="48" data-member-id="U8Q8YEZCJ"></span>
					<span class="member_image thumb_36" style="background-image: url('https://secure.gravatar.com/avatar/02ca67ae78f1829ea6fdb044a0547898.jpg?s=72&d=https%3A%2F%2Fa.slack-edge.com%2F66f9%2Fimg%2Favatars%2Fava_0017-72.png')" data-thumb-size="36" data-member-id="U8Q8YEZCJ"></span>
				</div>
				<h3>Signed in as</h3>
				<span id="user_menu_name">Rachael DeTar</span>
			</div>
		</div>
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				...
				<li><a href="https://slack.com/signout/287999210740?crumb=s-1516300337-e63c263bfc-%E2%98%83" data-qa="sign_out">Sign Out<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>
...
<li class="active">
	<a href="https://hort503-01-spring2018.slack.com/home" target="https://hort503-01-spring2018.slack.com/">
					<i class="ts_icon small ts_icon_check_circle_o active_icon s"></i>
							<i class="team_icon small default" >H5</i>
				<span class="switcher_label team_name">Hort 503-01 Spring 2018</span>
	</a>
</li>													
<li >
	<a href="https://cpts122lab.slack.com/home" target="https://cpts122lab.slack.com/">
							<i class="team_icon small default" >C1</i>
				<span class="switcher_label team_name">CPT_S 122 Lab</span>
	</a>
...
<p class="print_only">
	...
	Created by Stephen Ficklin on Thursday, January 18, 2018 at 10:25 AM
	</strong><br />
	<span class="subtle_silver break_word">https://hort503-01-spring2018.slack.com/files/U8FD10HA5/F8V5UTH0D/ex17_bad.py</span>
</p>
...
<div class="file_public_link_shared alert" style="display: none;">
	...
	<i class="ts_icon ts_icon_link"></i> Public Link: <a class="file_public_link" href="https://slack-files.com/T8FVD66MS-F8V5UTH0D-c6f4441126" target="new">https://slack-files.com/T8FVD66MS-F8V5UTH0D-c6f4441126</a>
</div></div>
...
<div id="file_page" class="card top_padding">
	...
	<p class="small subtle_silver no_print meta">
		...
		522b Python snippet created on <span class="date">January 18, 2018</span>.
	...
	<div class="large_bottom_margin clearfix">
		<pre id="file_contents">from sys import argv
...
<div class="loading_hash_animation">
	...
	<form action="https://hort503-01-spring2018.slack.com/files/U8FD10HA5/F8V5UTH0D/ex17_bad.py"
			id="file_comment_form"
							class="comment_form clearfix"
						method="post">
					<a href="/team/U8Q8YEZCJ" class="member_preview_link" data-member-id="U8Q8YEZCJ" >
				<span class="member_image thumb_36" style="background-image: url('https://secure.gravatar.com/avatar/02ca67ae78f1829ea6fdb044a0547898.jpg?s=72&d=https%3A%2F%2Fa.slack-edge.com%2F66f9%2Fimg%2Favatars%2Fava_0017-72.png')" data-thumb-size="36" data-member-id="U8Q8YEZCJ"></span>
			</a>
				<input type="hidden" name="addcomment" value="1" />
		<input type="hidden" name="crumb" value="s-1516300337-9e1b1e05c4-☃" />
...
<!--
	...
	var boot_data = {
		...
		user_id: 'U8Q8YEZCJ',
		team_id: 'T8FVD66MS',
		visitor_uid: ".b5yujy8h4xcsosgooskgco8cs",
		no_login: false,
		version_ts: '1516299945',
		version_uid: '2431708389d06b6f5a387d451cf666ed6e49f424',
		...
		api_url: '/api/',
		team_url: 'https://hort503-01-spring2018.slack.com/',
		image_proxy_url: 'https://slack-imgs.com/',
		beacon_timing_url: "https:\/\/slack.com\/beacon\/timing",
		beacon_error_url: "https:\/\/slack.com\/beacon\/error",
		clog_url: "clog\/track\/",
		api_token: 'xoxs-287999210740-296304509426-296225962963-e5ab27b62d',
		ls_disabled: false,
	...
	codemirror_files: {
		...
		feature_esc_connected_workspaces: true,
		...
		feature_wta_management_modal: true,
	...
	// client boot data
		...
		boot_data.ms_connect_url = "wss:\/\/mpmulti-VBSL.lb.slack-msgs.com\/?flannel=2&token=xoxs-287999210740-296304509426-296225962963-e5ab27b62d";
...
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-core_required_libs.323fffa774ed7a20d33e.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>

	<!-- output_js "application" -->
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/modern.vendor.d4dd99f0449486f32670.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/application.cb9782a28bbc3f0381c7.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>

	<!-- output_js "core" -->
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-core_required_ts.26ab4a4f8a079769b419.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/TS.web.d6541d8b3786f23dfa84.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>

	<!-- output_js "core_web" -->
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-core_web.76d2195d4493f172ed0b.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>

	<!-- output_js "secondary" -->
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-secondary_a_required.eb85ad52a835999f08b3.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-secondary_b_required.7922a147c51a68b8ef56.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
	...
	<!-- output_js "regular" -->
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/TS.web.comments.f56b3e7c158caab655b5.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/TS.web.file.bc16a35519d0a2067f3c.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/codemirror_load.ca4f26b018edcede90ce.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
	...
	<!--
		...
		boot_data.file = {"id":"F8V5UTH0D","created":1516299915,"timestamp":1516299915,"name":"ex17_bad.py","title":"ex17_bad.py","mimetype":"text\/plain","filetype":"python","pretty_type":"Python","user":"U8FD10HA5","editable":true,"size":522,"mode":"snippet","is_external":false,"external_type":"","is_public":true,"public_url_shared":false,"display_as_bot":false,"username":"","url_private":"https:\/\/files.slack.com\/files-pri\/T8FVD66MS-F8V5UTH0D\/ex17_bad.py","url_private_download":"https:\/\/files.slack.com\/files-pri\/T8FVD66MS-F8V5UTH0D\/download\/ex17_bad.py","permalink":"https:\/\/hort503-01-spring2018.slack.com\/files\/U8FD10HA5\/F8V5UTH0D\/ex17_bad.py","permalink_public":"https:\/\/slack-files.com\/T8FVD66MS-F8V5UTH0D-c6f4441126","edit_link":"https:\/\/hort503-01-spring2018.slack.com\/files\/U8FD10HA5\/F8V5UTH0D\/ex17_bad.py\/edit","preview":"from sys import argv\r\nfrom os.path import exists\r\n\r\nfrom_file, to_file = argv\r\n\r","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\" oncopy=\"if(event.clipboardData){event.clipboardData.setData('text\/plain',window.getSelection().toString().replace(\/\\u200b\/g,''));event.preventDefault();event.stopPropagation();}\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Efrom\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Esys\u003C\/span\u003E \u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Eargv\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Efrom\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Eos\u003C\/span\u003E.\u003Cspan class=\"cm-property\"\u003Epath\u003C\/span\u003E \u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Eexists\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E&#8203;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-variable\"\u003Efrom_file\u003C\/span\u003E, \u003Cspan class=\"cm-variable\"\u003Eto_file\u003C\/span\u003E = \u003Cspan class=\"cm-variable\"\u003Eargv\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E&#8203;\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":25,"lines_more":20,"preview_is_truncated":false,"channels":["C8FVD6804"],"groups":[],"ims":[],"comments_count":1,"initial_comment":{"id":"Fc8V2CQGFL","created":1516299915,"timestamp":1516299915,"user":"U8FD10HA5","is_intro":true,"comment":"This is the buggy python script we'll use for exercise 4 in class."},"pinned_to":["C8FVD6804"]};
		boot_data.file.comments = [{"id":"Fc8V2CQGFL","created":1516299915,"timestamp":1516299915,"user":"U8FD10HA5","is_intro":true,"comment":"This is the buggy python script we'll use for exercise 4 in class."}];
...
<!-- slack-www-hhvm-03f2ecb8c60402f2d / 2018-01-18 10:32:17 / v2431708389d06b6f5a387d451cf666ed6e49f424 / B:H -->
